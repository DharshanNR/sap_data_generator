...
class SAPDataGenerator:
    ...
    def generate_SAP_data(self):
        ...
        generator._calculate_vendor_weights()
        generator.generate_lfa1()
        generator.generate_mara()
        generator.generate_vendor_contract()
        generator.generate_ekko()
        generator.generate_ekpo()
        generator.generate_ekbe()
